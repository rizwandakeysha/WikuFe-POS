  ...
  const filterByMonth = (month) => {
    if (month) {
      const filteredData = transaksi.filter((t) => {
        ...
        return (
          tgl_transaksi.getMonth() === month.getMonth() &&
          tgl_transaksi.getFullYear() === month.getFullYear()
        );
      });
  ...
  return (
    <div className="my-16 mx-16">
      <div class="flex items-center justify-center">
        <h1 class="text-center text-4xl font-bold" style={{ fontFamily: "Outfit" }}>Transaksi per Bulan</h1>
      </div>
      <br />
