    ...
    <ul class="flex flex-col py-4 mx-5">
      <li>
        <a href="/" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><Icon icon="material-symbols:area-chart" /></span>
          <span class="text-md font-medium">Grafik Penjualan</span>
        </a>
      </li>
      <li>
        <a href="data_transaksi_t" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><Icon icon="mdi:auto-pay" /></span>
          <span class="text-md font-medium">Data Transaksi (T)</span>
        </a>
      </li>
      <li>
        <a href="data_transaksi_b" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><Icon icon="mdi:auto-pay" /></span>
          <span class="text-md font-medium">Data Transaksi (B)</span>
        </a>
      </li>
      <li>
        <a href="data_transaksi_k" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
          <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><Icon icon="mdi:auto-pay" /></span>
